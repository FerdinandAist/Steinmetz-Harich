...
export const routes = {
  ...
  'gedenksteine-steinwerke': {
    ...
    title: 'Gedenksteine & Steinwerke | Harich Rhein-Sieg-Kreis bis Kln',
    description: 'Gedenksteine, Steinlichter, Findlinge, Basaltsulen, Brunnen, Schalen, Skulpturen und Steinobjekte der Steinmetzwerkstatt Harich.',
    navTitle: 'Gedenksteine & Steinwerke',
    eyebrow: 'Auswahl finden',
    h1: 'Welche Steinlsung suchen Sie',
    lead: 'Whlen Sie zuerst den Bereich, der zu Ihrem Anliegen passt. Danach fhren wir Sie zu den passenden Unterseiten.',
    decision: {
      question: 'Was mchten Sie gestalten lassen',
      options: [
        ['Erinnerung & Grabmal', 'Gedenksteine, Grabmale, Steinlichter, Findlinge und Basaltsulen.', '/gedenksteine-steinwerke/erinnerung-grabmal/'],
  ...
  'handwerk-gestaltung': {
    ...
    description: 'Persnliche Beratung, Entwurf, Schrift, Symbol, Umsetzung, Werkstattgeschichte und Bruno Johannes Harich im berblick.',
    navTitle: 'Handwerk & Gestaltung',
    eyebrow: 'Auswahl finden',
    h1: 'Wobei mchten Sie Orientierung',
    lead: 'Whlen Sie zuerst, ob Sie den Gestaltungsprozess verstehen oder die Meisterwerkstatt kennenlernen mchten.',
    decision: {
      question: 'Was mchten Sie zuerst ansehen',
      options: [
        ['Gestaltung verstehen', 'Gesprch, Idee, Entwurf, Schrift, Symbol und handwerkliche Umsetzung.', '/handwerk-gestaltung/gestaltung-verstehen/'],
        ['Werkstatt kennenlernen', 'Haltung, Geschichte, Bruno Johannes Harich und das Referenzprojekt Mahnender Mhlstein.', '/handwerk-gestaltung/werkstatt-kennenlernen/'],
      ],
    },
    faq: commonFaq,
  },
  ...
  'gedenksteine-steinwerke/erinnerung-grabmal': {
    ...
    description: 'Auswahl fr Gedenksteine, Grabmale, Steinlichter, Findlinge und Basaltsulen der Steinmetzwerkstatt Harich.',
    navTitle: 'Erinnerung & Grabmal',
    eyebrow: 'Gedenksteine & Steinwerke',
    h1: 'Was soll als Erinnerung gestaltet werden',
    lead: 'Whlen Sie die passende Richtung. Jede Unterseite fhrt weiter zu Beratung, Gestaltung und konkreten Mglichkeiten.',
    choices: [
      ['Gedenksteine bersicht', 'Alle Mglichkeiten rund um individuelle Grabmale und Erinnerung in Stein.', '/gedenksteine/'],
      ['Innovative Gedenksteine', 'Freie Formen, persnliche Symbole und individuelle Entwrfe.', '/gedenksteine/innovative-gedenksteine/'],
      ['Klassische Gedenksteine', 'Ruhige, bewhrte Formen mit handwerklicher Przision.', '/gedenksteine/klassische-gedenksteine/'],
      ['Findlinge & Basaltsulen', 'Natrliche Steinformen fr naturverbundene Erinnerungszeichen.', '/gedenksteine/findlinge-basaltsaeulen/'],
      ['Steinlichter', 'Licht, Stein und Erinnerung als stilles Zeichen am Grab.', '/gedenksteine/steinlichter/'],
    ],
  ...
  'gedenksteine-steinwerke/haus-garten': {
    ...
    description: 'Auswahl fr Brunnen, Schalen, Skulpturen, Accessoires und freie Steinobjekte aus Naturstein.',
    navTitle: 'Haus, Garten & besondere Orte',
    eyebrow: 'Gedenksteine & Steinwerke',
    h1: 'Welches Steinwerk passt zu Ihrem Ort',
    lead: 'Whlen Sie die passende Objektart. Die Unterseiten zeigen Mglichkeiten fr Haus, Garten, Eingang und besondere Orte.',
    choices: [
      ['Steinobjekte bersicht', 'Brunnen, Schalen, Skulpturen und Accessoires im berblick.', '/steinobjekte/'],
      ['Brunnen', 'Wasser und Stein als ruhiger Mittelpunkt im Garten.', '/steinobjekte/brunnen/'],
      ['Schalen', 'Handwerkliche Steinformen fr Innen- und Auenrume.', '/steinobjekte/schalen/'],
      ['Skulpturen', 'Knstlerische Arbeiten aus Naturstein.', '/steinobjekte/skulpturen/'],
      ['Accessoires', 'Kleine Steinobjekte mit besonderer Materialwirkung.', '/steinobjekte/accessoires/'],
    ],
    backHref: '/gedenksteine-steinwerke/',
  },
  'handwerk-gestaltung/gestaltung-verstehen': {
    ...
    description: 'Auswahl fr Beratung, Idee, Entwurf, Entstehung, Umsetzung, Schrift und Symbol bei Steinmetzwerkstatt Harich.',
    navTitle: 'Gestaltung verstehen',
    eyebrow: 'Handwerk & Gestaltung',
    h1: 'Welcher Teil der Gestaltung interessiert Sie',
    lead: 'Hier finden Sie die Schritte vom ersten Gesprch bis zur handwerklichen Umsetzung.',
    choices: [
      ['Gestaltung bersicht', 'Der Weg vom Gedanken zum individuellen Steinwerk.', '/gestaltung/'],
      ['Idee & Entwurf', 'Aus Erinnerungen, Worten und Bildern entsteht eine klare Richtung.', '/gestaltung/idee-und-entwurf/'],
      ['Entstehung & Umsetzung', 'Vom ausgewhlten Stein bis zur handwerklichen Fertigung.', '/gestaltung/entstehung-und-umsetzung/'],
      ['Schrift & Symbol', 'Persnliche Zeichen, Schriften und Oberflchen mit Bedeutung.', '/gestaltung/schrift-und-symbol/'],
    ],
  ...
  'handwerk-gestaltung/werkstatt-kennenlernen': {
    ...
    description: 'Auswahl zu Philosophie, Chronik, Bruno Johannes Harich und dem Referenzprojekt Mahnender Mhlstein.',
    navTitle: 'Werkstatt kennenlernen',
    eyebrow: 'Handwerk & Gestaltung',
    h1: 'Was mchten Sie ber die Werkstatt erfahren',
    lead: 'Lernen Sie Haltung, Herkunft, Bruno Johannes Harich und ein besonderes Referenzprojekt kennen.',
    choices: [
      ['Werkstatt bersicht', 'Meisterwerkstatt, Beratung und Handwerk seit 1958.', '/werkstatt/'],
      ['Philosophie', 'Warum ein Steinwerk mit Aufmerksamkeit beginnt.', '/werkstatt/philosophie/'],
      ['Chronik', 'Seit 1958 in Eischeid verwurzelt.', '/werkstatt/chronik/'],
      ['Bruno Johannes Harich', 'Steinmetz- und Steinbildhauermeister mit persnlicher Handschrift.', '/werkstatt/bruno-johannes-harich/'],
      ['Mahnender Mhlstein', 'Referenzprojekt fr Papst Franziskus.', '/mahnender-muehlstein-papst-franziskus/'],
    ],
    backHref: '/handwerk-gestaltung/',
  },
  'gedenksteine': {
