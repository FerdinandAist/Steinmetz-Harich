...
function detail(navTitle, h1, lead, image, alt) {
  return {
    ...
    description: lead + ' Pers\u00f6nliche Beratung in Neunkirchen-Seelscheid, Eischeid, Rhein-Sieg-Kreis und bis K\u00f6ln.',
    navTitle,
    ...
    faq: [
      ['Wie beginnt die Beratung?', 'Am Anfang reicht ein erster Gedanke. Im Gespr\u00e4ch wird gekl\u00e4rt, welcher Ort, welche Wirkung und welche Gestaltung zu Ihrem Anliegen passen.'],
      ['Worauf kommt es bei der Gestaltung besonders an?', 'Wichtig sind eine klare Gestaltungsidee, passendes Material, gute Proportionen und eine pers\u00f6nliche Beratung, die Ihre Vorstellungen ernst nimmt.'],
      ...
      ['Kann die Arbeit individuell gestaltet werden?', 'Ja. Form, Oberfl\u00e4che, Schrift, Symbol und Details werden im Gespr\u00e4ch entwickelt und auf den jeweiligen Ort abgestimmt.'],
